...
/***/ "./src/_factories/ajax_requests.js":
/*!*****************************************!*\
  !*** ./src/_factories/ajax_requests.js ***!
  \*****************************************/
...
/* harmony export */   "RequestBodyFactory": () => (/* binding */ RequestBodyFactory)
/* harmony export */ });
/* harmony import */ var _global_global__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../_global/global */ "./src/_global/global.js");

function RequestFactory(action) {
  const request = new Request(action // "./request/reorder_task"
  );
  return request;
}
function RequestBodyFactory(context) {
  /*
      Factory Parameters
      context = {
          "type": type,
  ...
  */
  ...
  if (context['type'] == "application/json") {
    header = {
      ...
      //'application/json',
      'X-CSRFToken': _global_global__WEBPACK_IMPORTED_MODULE_0__.csrftoken //csrftoken
...
let speech_ai = (() => {
  let tts = window.speechSynthesis; //Prototype onject
...
/***/ "./src/applicant_portfolio/pwdjob_applications.js":
/*!********************************************************!*\
  !*** ./src/applicant_portfolio/pwdjob_applications.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var create_qualification = (() => {
  ...
  function clone_template() {
    ...
    qualification_template.querySelectorAll("[name='qualification_required']").forEach(e => {
      e.setAttribute("name", "qualification_required");
    });
...
if (location.href.indexOf('employer/addjob') != -1) {
  ...
  let id = 0;
  if (data[0] == 127) id = data[5];else id = data[0];

  if (id != null) {
    document.getElementsByName("qualification-experience")[0].remove();

    async function loadQualifications() {
      const request = (0,_factories_ajax_requests__WEBPACK_IMPORTED_MODULE_1__.RequestFactory)("/ajax/requestqualifications/" + id);
      const body = (0,_factories_ajax_requests__WEBPACK_IMPORTED_MODULE_1__.RequestBodyFactory)({
        "method": "POST"
      });
      const response = await fetch(request, body);
...
/***/ "./src/employer_dashboard/view_applicants.js":
/*!***************************************************!*\
  !*** ./src/employer_dashboard/view_applicants.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/job_search_engine/pwdjobsearch.js":
/*!***********************************************!*\
  !*** ./src/job_search_engine/pwdjobsearch.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.getElementById("pwdsearchbar").addEventListener("submit", e => {
  e.preventDefault();
  let query = document.getElementById("pwdinput-searchbar").value;
  location.replace("/pwdfindjob?q=" + query);
});

if (location.href.indexOf('pwdfindjob') != -1) {
  let jobsearch = (() => {
    //private members:
    function EventBubble() {
      document.getElementById("searchjob-bubble").addEventListener("click", e => {
        if (e.target.getAttribute("id") == "btn-apply") {
          window.location.replace("./pwdapplyjob/" + e.target.getAttribute("data-id") + "/");
        }
      });
      document.querySelectorAll(".card-results").forEach(job_card => {
        job_card.addEventListener("click", async e => {
          ...
          if (response.status == 200) {
            ...
            console.log(data);
            document.getElementById("job-info").innerHTML = `
                            <div class="abstract text-white card-bg">
                                <h5>` + data['job_title'] + `</h5>
                                <h6>` + data['employer']['company_name'] + ` - ` + data['location'] + `</h6>
                                <h6>PHP ` + parseFloat(data['initial_salary']).toLocaleString() + ` - Fulltime, Permanent - Remote</h6>
                                <button class="btn btn-apply" id="btn-apply" data-id="` + data['id'] + `">Apply Now</button>
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "Skillfind:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkSkillfind"] = self["webpackChunkSkillfind"] || [];
...
/* harmony import */ var _job_search_engine_pwdjobsearch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./job_search_engine/pwdjobsearch */ "./src/job_search_engine/pwdjobsearch.js");
const {
  login
...
const {
  applicant_skill
} = __webpack_require__(/*! ./applicant_portfolio/skill */ "./src/applicant_portfolio/skill.js");
...
const {
  pwdjob_applications
} = __webpack_require__(/*! ./applicant_portfolio/pwdjob_applications */ "./src/applicant_portfolio/pwdjob_applications.js");
...
const {
  load_qualifications
} = __webpack_require__(/*! ./employer_dashboard/load_qualifications */ "./src/employer_dashboard/load_qualifications.js");
...
const {
  handicapped_signup
} = __webpack_require__(/*! ./app_handicapped/signup */ "./src/app_handicapped/signup.js");
...
const {
  view_applications
} = __webpack_require__(/*! ./employer_dashboard/view_applicants */ "./src/employer_dashboard/view_applicants.js");
